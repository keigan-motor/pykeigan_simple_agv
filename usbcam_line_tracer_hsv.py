...
# Check the USB camera information using "v4l2-ctl"
...
if __name__ == '__main__':
    ...
    try:
        ...
        while(True):
            ...
            #roi_ar = image[160:320, 100:540]
            #corners,ids = aruco_reader(roi_ar) #ArUcoマーカー検知
            #isArucoMarker = aruco_reader_get_state(corners,ids)
